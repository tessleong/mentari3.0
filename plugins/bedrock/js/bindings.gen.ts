...
export const commands = {
  ...
  ): Promise<Result<ListFoundationModelsResponse, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:bedrock|list_foundation_models", {
          request,
        }),
      };
    } catch (e) {
...
export type FoundationModelSummary = {
  modelId: string | null;
  ...
  customizationsSupported: string[] | null;
  inferenceTypesSupported: string[] | null;
  modelArn: string | null;
};
export type ListFoundationModelsRequest = {
