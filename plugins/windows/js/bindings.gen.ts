...
export type EditorView = { type: "raw" } | { type: "transcript" } | { type: "enhanced"; id: string } | { type: "attachments" } | { type: "plain_english" }
...
export type FloatingBarState = { amplitude: number; title: string; durationSeconds: number; status: FloatingBarStatus; colorScheme: FloatingBarColorScheme; opacity: number; liveCaptionOpacity: number; liveCaptionWidth: number; liveCaptionLineCount: number; liveCaptionPosition: LiveCaptionPosition; liveCaptionMinimized: boolean; liveCaptionToggleVisible: boolean; transcriptBubbles?: FloatingTranscriptBubble[] | null }
