...
mod tests {
    ...
    tpl_snapshot!(
        ...
        TestParticipants {
            participants: vec![
                Participant { name: "Alice".to_string(), job_title: Some("Engineer".to_string()), role: None },
                Participant { name: "Bob".to_string(), job_title: None, role: None },
            ],
        },
        @"
    ...
    tpl_snapshot!(
        test_macro_participants_with_role,
        TestParticipants {
            participants: vec![
                Participant {
                    name: "Dr. Chau".to_string(),
                    job_title: Some("MD".to_string()),
                    role: Some("clinician".to_string()),
                },
                Participant { name: "Me".to_string(), job_title: None, role: Some("patient".to_string()) },
            ],
        },
        @"

    - Dr. Chau (MD) [clinician]
    ...
    tpl_snapshot!(
        ...
        TestParticipantsList {
            participants: vec![
                Participant { name: "Alice".to_string(), job_title: Some("CEO".to_string()), role: None },
                Participant { name: "Bob".to_string(), job_title: None, role: None },
            ],
        },
        @"
    ...
    tpl_snapshot!(
        test_macro_participants_list_with_role,
        TestParticipantsList {
            participants: vec![
                Participant {
                    name: "Dr. Chau".to_string(),
