...
pub enum SyncError {
    ...
    #[error("Mentari Pro is required for CloudSync")]
    ProPlanRequired,

    #[error("A newer Mentari version is required for encrypted CloudSync")]
    ...
    fn into_response(self) -> Response {
        let (status, code, message) = match self {
            ...
            Self::ProPlanRequired => (
                ...
                "Mentari Pro is required for CloudSync".to_string(),
            ),
            Self::CloudsyncUpgradeRequired => (
                StatusCode::UPGRADE_REQUIRED,
                "cloudsync_upgrade_required",
                "Update Mentari to continue using encrypted CloudSync".to_string(),
            ),
            ...
            Self::SnapshotChanged => (
                StatusCode::CONFLICT,
                "snapshot_conflict",
                "Shared note changed; update Mentari and reload before publishing again"
                    .to_string(),
            ),
