...
Mentari separates the language used for summaries and chat from the languages it should expect in a conversation.

## Choose the main language

Open **Settings → General** and choose **Main language** under **Language & Region**.

Mentari uses the main language for summaries, chat, and other AI-generated responses. It is also always included as a transcription language.
