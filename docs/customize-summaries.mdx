...
Use a named template when you want fixed sections. Customize Auto when you want to control Mentari's default summary prompt.
...
The Auto prompt applies only when **Auto** is selected. Named templates continue to use their configured sections and do not inherit the Auto customization. Use **Reset to Mentari default** to restore the built-in prompt.
