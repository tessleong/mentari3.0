...
export function InstructionScreen({
  ...
  if (type === "billing") {
    return (
      <ExternalInstruction
        ...
        description={t`Finish checkout in your browser, then return to Mentari.`}
  ...
  return (
    <ExternalInstruction
      ...
      description={t`Authorize access in your browser, then return to Mentari.`}
...
function SignInInstruction({ onBack }: { onBack: () => void }) {
  ...
  return (
    <InstructionShell
      ...
      description={t`Complete sign-in in your browser, then return to Mentari.`}
      onBack={onBack}
    >
      {showCallbackInput ? (
        <>
          <div className="flex w-full flex-col gap-2">
            <Input
              ...
              placeholder="mentari://auth/callback?access_token=..."
              value={callbackUrl}
