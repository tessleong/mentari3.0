    ...
    >
      <div className="absolute inset-x-0 top-0 -translate-y-1/2">
        <div
          ...
          className="bg-primary/85 dark:bg-primary/70 absolute top-1/2 right-0 left-0 h-px -translate-y-1/2"
        />
        <div className="relative flex h-5 items-center justify-center">
          <div
            data-sidebar-current-time-label
            className="border-primary bg-primary text-primary-foreground dark:border-primary dark:bg-primary dark:text-primary-foreground rounded-full border px-2 py-0.5 font-mono text-[11px] font-semibold opacity-0 shadow-xs transition-opacity group-hover:opacity-100"
          >
            {label}
          </div>
        </div>
