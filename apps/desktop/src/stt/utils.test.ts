...
describe("getAssignedHumanIdsForChannel", () => {
  it("returns humans assigned on the given channel", () => {
    const hints = [
      {
        id: "word-1:user_speaker_assignment",
        word_id: "word-1",
      ...
      {
        id: "word-2:user_speaker_assignment",
        word_id: "word-2",
        type: "user_speaker_assignment" as const,
        value: JSON.stringify({
          human_id: "sarah",
    ...
    expect(getAssignedHumanIdsForChannel(hints, 1)).toEqual(["evan", "sarah"]);
  });

  it("ignores assignments on a different channel", () => {
    const hints = [
      {
        id: "word-1:user_speaker_assignment",
        word_id: "word-1",
    ...
    expect(getAssignedHumanIdsForChannel(hints, 1)).toEqual([]);
  });

  it("ignores segment-scoped assignments (not tied to a speaker index)", () => {
    const hints = [
      {
        id: "word-1:user_speaker_assignment:segment",
        word_id: "word-1",
  ...
  it("ignores automatic assignments, only surfacing ones the user made", () => {
    const hints = [
      {
        id: "word-1:automatic_speaker_assignment",
        word_id: "word-1",
        type: "automatic_speaker_assignment" as const,
        value: JSON.stringify({ human_id: "evan" }),
      },
    ];
  ...
  it("deduplicates a human assigned to multiple speaker indices on the same channel", () => {
    const hints = [
      {
        id: "word-1:user_speaker_assignment",
        word_id: "word-1",
    ...
    expect(getAssignedHumanIdsForChannel(hints, 1)).toEqual(["evan"]);
  });
});
