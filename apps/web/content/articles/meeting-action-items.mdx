...
[Mentari](/download) keeps meeting notes, transcripts, and summaries in a local SQLite record, so you can retain the source context, export Markdown when useful, and hand accepted work to the task system your team already uses.
