...
## A practical decision-log workflow in Mentari

Mentari is designed around the idea that you should remain the note-taker while AI handles the mechanical work around you.
...
3. Let Mentari transcribe the conversation while you stay engaged.
...
If you need a better capture layer for that workflow, [Mentari](https://anarlog.so) provides bot-free meeting transcription, editable summaries, templates, chat, and on-device or bring-your-own-key AI.
...
Ready to build a meeting record you can verify and keep? [Download Mentari](/download).
