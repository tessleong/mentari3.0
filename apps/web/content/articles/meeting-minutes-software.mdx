...
This guide compares the strongest options for 2026 and calls out where Mentari fits for teams that want AI meeting minutes without giving up control over their data.
...
| --- | --- | --- | --- |
| Mentari | Private AI minutes and local-first workflows | No bot; desktop system-audio capture | Free; Pro is $15/month or $150/year |
...
### 1. Mentari - control over your data and AI stack

![Mentari](/api/assets/blog/articles/meeting-minutes-software/char-summary.png)

**[Mentari](https://anarlog.so)** is an open-source AI note-taker that stores your data locally and gives you complete control over the AI stack.
...
Mentari captures system audio without joining meetings as a bot. During meetings, it transcribes conversations in real time and combines any notes you've taken with the transcript to create a summary when the meeting ends.
...
- **Local-first processing** (Mentari) provides maximum privacy
...
If you value both functionality and local-first control, Mentari is worth a look. Meeting data stays in local SQLite by default, and you can export Markdown when a portable copy fits the workflow.
...
You can try Mentari for free. If it is not for you, export everything and walk away.
