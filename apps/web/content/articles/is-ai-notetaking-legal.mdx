...
- **Safer choice:** Cloud-based tools demand heavy due diligence, while zero-lock-in solutions (like Mentari) minimize compliance risks with complete control over your data and AI stack.
...
Mentari works differently. You decide how your data is processed — [local models on your device](/blog/local-ai-meeting-notes/), your own cloud API keys, or Mentari's managed service. Meeting data stays in local SQLite by default, and IT teams can audit the open-source code. That gives you more control over the compliance questions you still need to assess.
...
![Mentari ai notetaker](/api/assets/blog/is-ai-notetaking-legal/legal-1.webp)

Mentari has an Apple Notes-like interface that feels instantly familiar, with AI running in the background.
...
The AI works hands-off if you want it to. You can also jot down key points yourself, and Mentari will expand your notes with context from the transcript.
...
[Download Mentari for MacOS](/download) to take control of your meeting data.
