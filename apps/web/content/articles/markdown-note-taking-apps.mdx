...
| Mentari     | Meeting notes                  | ✅               | ✅               | Free / $15/mo     |
...
### 1. Mentari: best markdown note-taking app for meetings

![](/api/assets/blog/articles/markdown-note-taking-apps/image-1.png)

**[Mentari](https://anarlog.so/)** is an open-source AI notepad built specifically for meetings. It transcribes your conversations in real time and combines the transcript with your manual notes to create a structured summary. No bots join your calls; meeting data is stored locally in SQLite, and you can choose your preferred STT and LLM provider.
...
- Your choice of AI stack - Use Mentari's managed cloud service, bring your own API keys (OpenAI, Anthropic, Deepgram, others), or run fully local via Ollama or LM Studio
...
- [Meeting notes](/blog/obsidian-meeting-notes/) from Mentari land directly in your vault since both use markdown
...
If you're in back-to-back meetings and losing track of what was said and decided, start with **Mentari**. Everything else on this list is for organizing knowledge you've already captured - Mentari is for capturing it in the first place.
