...
## Where Mentari comes in

At [Mentari](/), we're building an open-source AI notepad for meetings that keeps your meeting record in local SQLite. You choose your AI stack—managed cloud, bring your own keys, or local models—and can export Markdown when you need it.
...
Mentari isn't just about note-taking. It lets AI enhance your work without owning it.
...
- **Cognition** → Mentari (and others like it)
...
If you've ever used DuckDuckGo, Brave, or Proton and wished there was something similar for your meetings, we built Mentari for you.
