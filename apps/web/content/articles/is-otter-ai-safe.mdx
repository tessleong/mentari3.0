...
**Mentari** is the [best Otter AI alternative](/blog/otter-ai-alternatives) and an open-source AI notepad for meetings that gives you complete control over your data and AI stack. Meeting data is stored locally in SQLite instead of a vendor-hosted workspace. Markdown is available when you want to export it.
...
Mentari's Free plan supports on-device transcription and your own API keys. Local-first storage and open-source code can make technical review easier, but organizations remain responsible for assessing privacy, security, and compliance requirements.

[Download Mentari for MacOS](/download) and experience meeting notes with zero lock-in.
