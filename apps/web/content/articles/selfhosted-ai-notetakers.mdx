...
meta_description: "Six open-source AI meeting notetakers you can self-host — from full meeting workspaces to raw transcription pipelines. Covers Mentari, Meetily, Scriberr, Vibe, Whishper, and WhisperX."
author:
  - "John Jeong"
featured: false
...
| **Mentari**     | MIT         | macOS           | Parakeet V3, Parakeet Batch + 7 cloud         | Ollama / LM Studio | Free (local) · $15/mo cloud |
...
![Mentari review](/api/assets/blog/articles/selfhosted-ai-notetakers/char-summary.png "char-editor-width=80")

[Mentari](https://anarlog.so/) is the only tool on this list that handles the full meeting workflow in one app — capture, transcription, note-taking, summarization, and structured export.
...
**Transcription:** Pick from 9 STT providers in Preferences. Local Parakeet models run fully on-device, and the other providers are cloud BYOK: paste your API key, audio goes to that provider, Mentari never touches it.
...
- If you want a full meeting workspace, Mentari is the most complete option on this list.
...
For most users who want privacy-first meeting notes that just work, start with [Mentari](https://anarlog.so/download/apple-silicon). Free for fully local use, no account required.
