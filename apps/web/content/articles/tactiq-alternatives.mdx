...
| **Mentari**         | No                   | Developers and tech founder who want control over their data and AI stack | Free (local/BYOK); Pro $15/mo           |
...
![Mentari vs Tactiq](/api/assets/blog/articles/tactiq-alternatives/char-summary.png "char-editor-width=80")

[Mentari](https://anarlog.so) is an open-source AI notepad for meetings, built for people who want to own their data.

Where Tactiq captures text inside Chrome, Mentari is a desktop app that records system audio from any meeting platform: Zoom, Teams, phone calls, even in-person conversations.
...
- Save your notes in your desired folder. If Mentari disappeared tomorrow, your data would still be exactly where you left it.
- You choose your own AI stack: Mentari's managed cloud, your own API keys (OpenAI, Anthropic, Deepgram), or fully local models through Ollama or LM Studio for offline operation.
...
[Granola](https://granola.ai) is a desktop app that, like Mentari, captures system audio and skips the bot. You take notes during the meeting in Granola's notepad, and the AI fills in everything you missed using the transcript. The calendar sync works out of the box, and the note quality is consistently strong.
...
- Works on macOS and Windows, which gives it broader reach than Mentari's macOS/Linux support.
...
**Mentari** is the pick if data ownership is non-negotiable: local SQLite storage, portable exports, your choice of AI, and a local-only configuration.
...
If you want prefer the local-first approach, [download Mentari](https://anarlog.so/download/apple-silicon) and try it on your next meeting.
