...
If you're using [Mentari AI Notetaker](/), use Search (cmd + k) to find every past mention of the project or topic. Type the project name, and you'll see every note where it was discussed, with the exact context of who said what and when.
...
During the meeting, focus entirely on participation. Use a tool like Mentari that runs locally on your device, automatically capturing both what's said and what you're thinking. No bot joining the call, no data leaving your machine, just automatic documentation.

If you prefer manual note-taking, jot down fragments, keywords, reactions. But don't try to create polished, comprehensive notes in real-time. You can use Mentari to enhance your manual notes using the meeting transcript afterward.
...
Use Mentari's automatic capture so you're not doing the mental gymnastics of trying to remember everything from each meeting.
...
- **Review your action items immediately.** Don't wait until later when everything blurs together. With Mentari, ask AI Chat "What are my action items?" and get them instantly from your meeting transcript.
...
- **Check what you committed to in the last one.** Search your past notes for action items with your name. With Mentari's Search, find every instance where you said "I'll handle this" or "I'll follow up on that."
...
Use AI to handle the cognitive overhead that's not actually thinking. Let Mentari capture conversations automatically, locally on your device without any data leaving your machine. Search across all your past meetings to find context instantly. Ask AI specific questions about what was discussed instead of hunting through transcripts.
...
[Download Mentari free](/download) and participate in meetings without the cognitive overhead.
