...
If you're using Mentari AI Notetaker, open Contacts View in Finder and search the person's name. You'll see every 1:1 you've had with them, organized chronologically. Click on any past meeting and use AI Chat to ask:
...
Use Mentari to automatically capture the entire conversation. It's open source, keeps meeting data in local SQLite, and lets you choose your AI stack—useful when conversations cover performance, compensation, or personal issues. No bot joins your call, and Markdown export is available when you need it.

After the meeting, Mentari gives you a complete transcript. Hover over any part of your AI-generated summary to see the exact quote from the conversation. Your manual notes get enhanced with full context without you having to choose between being present and capturing information.
...
With Mentari's custom templates, you can define exactly how your one-on-one notes should be structured. A 1:1 template might include:
...
Right after each 1:1, capture what needs follow-up action. With Mentari, ask AI Chat: "What commitments did I make?" and "What commitments did Alex make?"
...
Use Mentari to track development over time. Search across all your career conversations with someone to see: What goals did they set six months ago? Did they actually work toward them? What barriers kept coming up?
...
Here's what the actual workflow looks like when you're using Mentari:
...
- Let Mentari capture the conversation automatically—stay present, don't take frantic notes
...
Use AI to handle the overhead that's not actually management. Let Mentari capture conversations automatically—it is open source, local-first, and offers Markdown export for portable copies.
...
[Download Mentari free](/) and run one-on-ones that actually develop your team without burning you out.
