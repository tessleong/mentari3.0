...
If I have to recommend one platform that works universally, is free, and keeps your data local, it's Mentari.

Quick note: I'm the co-founder of Mentari, but my recommendation isn't just personal bias—the platform delivers results.
...
Mentari's note-taking features specifically:

![Mentari](/api/assets/blog/google-gemini-meeting-notes/gemini-2.webp)
...
Want to try Mentari? [Download it for free](/download)!
...
You have two main options: Google Meet's built-in transcription (which requires expensive Workspace subscriptions) or a third-party tool like Mentari.

Unlike cloud-based tools like Otter or Fireflies that send your conversations to their servers, Mentari provides unlimited real-time transcription completely free while keeping everything local on your device.
...
Yes—Mentari is a completely [free AI note taker](/blog/free-ai-notetakers) that works with Google Meet, Zoom, Teams, and any other meeting platform.

Unlike Google's "Take notes with Gemini" feature, which requires expensive Workspace subscriptions, Mentari's core transcription and note-taking features are free forever.
