...
meta_description: "Learn how to transcribe meetings without sending data to the cloud. Discover local AI tools like Mentari that keep conversations on-device and completely private."
author:
  - "John Jeong"
featured: false
category: "Guides"
...
**Short answer: Absolutely. And with Mentari, you choose exactly how.**
...
## **Enter Mentari: the AI notepad built around your choice**

[Mentari](https://anarlog.so) is an open-source AI notepad for meetings with zero lock-in and complete control over your data and AI stack.

### **You control how your data is processed**

Mentari lets you configure your own stack:

- **Transcription** — run it locally on your device, or use cloud APIs like Deepgram or AssemblyAI
- **AI Summarization** — use your own API keys (OpenAI, Anthropic, and others), run local models via Ollama or LM Studio, or use Mentari's managed service
- **Storage** — canonical meeting data stays locally in SQLite; Markdown is available as an export

### **Universal platform compatibility**

Mentari captures your microphone input and system audio directly — no bots joining your calls, no calendar permissions required. It works with all meeting platforms (Zoom, Teams, Meet, Slack), in-person meetings, and phone calls routed through your computer, with no platform-specific integrations needed.
...
No. Mentari delivers real-time transcription, AI summaries with action items and key decisions, custom templates for different meeting types, AI chat to query your transcripts, search across your meeting history, and support for 45+ languages including English, Spanish, French, German, Japanese, Portuguese, Italian, Dutch, Korean, and Chinese.

## **Mentari's privacy vs. performance spectrum**
...
Mentari lets you decide — local, hybrid, or cloud with your own API keys — with full visibility into what's happening, backed by open-source code you can inspect.
...
Mentari can produce transcripts and summaries without retaining the original audio. You decide what gets stored and where.

### **3. Can you use local transcription for languages other than English?**

Yes. Mentari supports 45+ languages including English, Spanish, French, German, Japanese, Portuguese, Italian, Dutch, Korean, and Chinese. If you want stronger multilingual AI summarization, you can connect your own cloud LLM provider.
