...
[Mentari](https://anarlog.so) is built for people who want AI meeting notes without handing every meeting to a cloud bot.

It captures system audio from your desktop, transcribes meetings in real time, and keeps the meeting record in local SQLite. You can export Markdown when you need a portable copy, then choose Mentari's managed service, bring your own API keys, or run local models through tools like Ollama or LM Studio.
...
Mentari is not trying to be a sales call library, CRM automation layer, or enterprise meeting intelligence suite. If your team needs automatic deal notes pushed into Salesforce, a bot-based or sales-focused meeting platform may be a better fit.

If your priority is private meeting memory you control, Mentari stays close to that job.
