...
| ------------------------ | ------------------------------------------------------ | -------------------------------------- |
| Mentari                     | AI meeting notes with local storage and your own LLM   | Free (BYOK) / Pro $15/mo or $150/year |
...
- No mobile app. If you need to record a call from your phone, Mentari can't help yet.
- No built-in CRM integrations. Meeting notes stay in Mentari unless you export or sync manually.
...
If your main problem is meeting notes and you want to own the transcript, Mentari captures system audio without a bot, stores everything locally, and lets you run any LLM you want. The tradeoff is macOS-only for now.
...
For meeting notes specifically, you can [download Mentari](https://anarlog.so/download) and try it in your next meeting.
