...
## Use your Mistral API key in Mentari for AI meeting notes that stay on your device

![](/api/assets/blog/articles/mistral-api-key/image-1.png)

Getting your own API key is a deliberate choice. It means you want control over what AI you're using and what happens to the data you send it. Mentari works on the same principles. 
...
The local meeting record, audio, transcript, and summary remain on your device by default. Mentari stores meeting data in local SQLite; if you enable cloud AI, CloudSync, or sharing, assess those services independently for the data you send to them.
...
To connect Mistral, open Mentari's settings, go to API Keys, paste your key, and that's it. Try it out for free now - [Download Mentari for macOS](https://anarlog.so/download/).
