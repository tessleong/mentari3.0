...
## Use OpenRouter to Take AI Notes Through Mentari

Mentari supports OpenRouter as an API provider option. When you bring your own OpenRouter API key, your meeting data routes through OpenRouter under your account settings.

If you configure OpenRouter with ZDR enabled and prompt logging off, those settings apply to requests Mentari sends through your account. If you have locked routing to a specific provider within OpenRouter, requests from Mentari will follow that configuration.

As with all Mentari integrations, your meeting notes are stored on your device. The AI provider processes your data to generate a summary, but the output lives locally. Switching from OpenRouter to a direct provider relationship, or to a local model, does not require any changes to how your notes are organized.

[Download Mentari for MacOS](https://anarlog.so/download) and use the AI provider your security team actually approves.