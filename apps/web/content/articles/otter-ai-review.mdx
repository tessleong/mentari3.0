...
| [Mentari](https://anarlog.so) | Local-first meeting data and AI-provider choice | Free (BYOK) / Pro $15/month or $150/year | Open source. Local SQLite with Markdown export. |
...
Mentari is an Otter alternative worth evaluating if you want open-source code, local-first meeting data, and AI-provider choice. It stores meeting data in local SQLite and supports managed cloud, your own keys, or local models, with Markdown export when you need a portable copy.
...
Otter.ai doesn't explicitly "sell" data, but their privacy policy states they use customer conversations to train AI models and share data with third-party processors. For complete control over your data, consider open-source alternatives like Mentari.

### 3. What are Otter.ai free plan features?

The free plan includes 300 monthly minutes, 30-minute conversation limit, 3 lifetime file imports, live transcription, basic speaker identification, and AI Chat with 20 queries/month. You keep only your 25 most recent conversations—older ones disappear. For comparison, alternatives like Mentari and Fathom offer unlimited free transcription.
...
Mentari (best for zero lock-in with complete control over data and AI), Fireflies (69+ languages for global teams), Fathom (unlimited free tier), Rev (99% human accuracy), and Jamie AI (offline + GDPR compliance).
